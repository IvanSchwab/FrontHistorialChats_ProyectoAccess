  ...
  return (
    <div className="dashboard">
      <div className="logout-container">
        <img src="src/images/logoAccess.png" alt="Logo Access" className="logo-header"/>
        <LogoutButton />
      </div>
