...
// Props que recibe ChatWindow
interface Props {
  selectedChat: Chat | null; // Chat seleccionado o null si no hay ninguno seleccionado
}

// Componente funcional ChatWindow
                ...
                <div>
                  <div className="icon">
                    {message.role === "ai" ? (
                      ...
                      <img
                        src="src/images/user-icon-color008000-20.png"
                        alt="user-icon"
                      />
                    )}
                  </div>{" "}
